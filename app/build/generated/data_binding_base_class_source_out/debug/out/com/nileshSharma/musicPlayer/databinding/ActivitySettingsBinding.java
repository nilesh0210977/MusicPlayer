...
public final class ActivitySettingsBinding implements ViewBinding {
  ...
  @NonNull
  public final Button appDescrption;
  ...
  private ActivitySettingsBinding(@NonNull LinearLayout rootView, @NonNull Button appDescrption,
    ...
    this.appDescrption = appDescrption;
  ...
  public static ActivitySettingsBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.app_descrption;
      Button appDescrption = ViewBindings.findChildViewById(rootView, id);
      if (appDescrption == null) {
        break missingId;
      }
      ...
      return new ActivitySettingsBinding((LinearLayout) rootView, appDescrption, coolBlackTheme,
          coolBlueTheme, coolGreenTheme, coolPinkTheme, coolPurpleTheme, sortBtn, versionName);
    }
