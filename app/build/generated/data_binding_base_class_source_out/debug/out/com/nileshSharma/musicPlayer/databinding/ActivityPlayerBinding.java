...
public final class ActivityPlayerBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageButton boosterBtnPA;
  ...
  @NonNull
  public final ImageButton repeatBtnPA;
  ...
  private ActivityPlayerBinding(@NonNull LinearLayout rootView, @NonNull ImageButton backBtnPA,
      @NonNull ImageButton boosterBtnPA, @NonNull ImageButton equalizerBtnPA,
      ...
      @NonNull ExtendedFloatingActionButton previousBtnPA, @NonNull ImageButton repeatBtnPA,
    ...
    this.boosterBtnPA = boosterBtnPA;
  ...
  public static ActivityPlayerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.boosterBtnPA;
      ImageButton boosterBtnPA = ViewBindings.findChildViewById(rootView, id);
      if (boosterBtnPA == null) {
        break missingId;
      }
      ...
      id = R.id.repeatBtnPA;
      ImageButton repeatBtnPA = ViewBindings.findChildViewById(rootView, id);
      if (repeatBtnPA == null) {
        break missingId;
      }
      ...
      return new ActivityPlayerBinding((LinearLayout) rootView, backBtnPA, boosterBtnPA,
          equalizerBtnPA, favouriteBtnPA, nextBtnPA, playPauseBtnPA, previousBtnPA, repeatBtnPA,
          seekBarPA, shareBtnPA, songImgPA, songNamePA, timerBtnPA, tvSeekBarEnd, tvSeekBarStart);
    }
