...
public final class NavHeaderBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout linearLayoutNav;

  private NavHeaderBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout linearLayoutNav) {
    this.rootView = rootView;
    this.linearLayoutNav = linearLayoutNav;
  }
  ...
  public static NavHeaderBinding bind(@NonNull View rootView) {
    ...
    LinearLayout linearLayoutNav = (LinearLayout) rootView;

    return new NavHeaderBinding((LinearLayout) rootView, linearLayoutNav);
  }
}
