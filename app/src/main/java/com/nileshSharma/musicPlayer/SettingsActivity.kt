...
import com.nileshSharma.musicPlayer.databinding.ActivitySettingsBinding
...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.appDescrption.setOnClickListener {
            var it:Intent=Intent(this,DescriptionActivity::class.java)
            startActivity(it)
        }
