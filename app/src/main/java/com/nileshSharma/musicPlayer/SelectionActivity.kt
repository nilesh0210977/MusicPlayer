...
import com.nileshSharma.musicPlayer.databinding.ActivitySelectionBinding
...
class SelectionActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        {
            binding.searchViewSA.backgroundTintList = ContextCompat.getColorStateList(this, R.color.black)
        }
    }
}